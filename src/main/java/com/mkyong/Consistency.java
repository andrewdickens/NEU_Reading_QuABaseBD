 ...
 */
public class Consistency extends DescriptionType {
		...
		public void setConsistencyDescription(String[][] descriptionMatrix) {
				...
				//				this.setObjectLevelIsolation(descriptionMatrix[2][1]);
				//				this.setObjectIsolationURL(descriptionMatrix[3][1]);
				//				this.setACIDtransactions(descriptionMatrix[4][1]);
				//				this.setACIDTransURL(descriptionMatrix[5][1]);
				//				this.setDistributedACIDTrans(descriptionMatrix[6][1]);
				//				this.setConstDistributedURL(descriptionMatrix[7][1]);
				//				this.setUpdatesAppliedBeforeWrite(descriptionMatrix[8][1]);
				//				this.setConstLogWritesURL(descriptionMatrix[9][1]);
				//				this.setSpecifyQuorumReadWrite(descriptionMatrix[10][1]);
				//				this.setQuorumURL(descriptionMatrix[11][1]);
				//				this.setSpecifyNumberToWrite(descriptionMatrix[12][1]);
				//				this.setReplicaURL(descriptionMatrix[13][1]);
				//				this.setBehaviorFailedReplica(descriptionMatrix[14][1]);
				//				this.setFailedReplicaURL(descriptionMatrix[15][1]);
				//				this.setWritesConfigNoFail(descriptionMatrix[16][1]);
				//				this.setNoFailURL(descriptionMatrix[17][1]);
				//				this.setSpecifyNumberToRead(descriptionMatrix[18][1]);
				//				this.setReplicaURL(descriptionMatrix[19][1]);
				//				this.setReadFromMaster(descriptionMatrix[20][1]);
				//				this.setObjectLevelTimestamps(descriptionMatrix[21][1]);
				//				this.setConstTimestampURL(descriptionMatrix[22][1]);
				//				this.setEfficientProtocalPropogation(descriptionMatrix[23][1]);
				//				this.setProtocalURL(descriptionMatrix[24][1]);
